...
<body id="page-top">
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top"> <a class="navbar-brand mr-1" href="index.html">Parking Officiel</a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <?php 
                        ...
                        echo '<button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button> <a class="btn btn-primary" href="'.BASE_URL.'/disconnect">Logout</a>'
